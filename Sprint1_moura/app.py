...
cursor.execute('''CREATE TABLE IF NOT EXISTS form_prot (
...
with open('FORM_PROTOTIPO.csv', 'r') as csvfile:
    ...
    for linha in leitor_csv:
        ...
        cursor.execute('''INSERT INTO form_prot ("Measurement_ID", "Time Stamp", "Step", "Status", "ProgTime", "StepTime",
                Cycle, "CycleLevel", Procedure_2, Voltage, Current, AhCha, AhDch, AhStep,
                AhAccu, WhAccu, WhCha, WhDch, WhStep, Channel0270101, Channel0280101,"x1", x2, x3)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?)''',
                (linha1, linha2, linha3, linha4, linha5, linha6, linha7, linha8,
                 linha9, linha10, linha11, linha12, linha13, linha14, linha15, linha16,
                 linha17, linha18, linha19, linha20, linha21,linha22,linha23,linha24))
